    ...
    try {
      ...
      section.innerHTML = [
        ...
        '<ul class="footnotes no-style">',
          ...
          '</li>',
          '<li>',
            '<sup>1</sup>See requirements for site-specific ground motions in ',
            'Section 11.4.7. Here the exception allowing use of the Site ',
            'Class C values of F<sub>a</sub> has been invoked.',
          '</li>',
          '<li>',
            'Note: Use straight-line interpolation for intermediate values ',
            'of S<sub>S</sub>.',
        ...
        '<ul class="footnotes no-style">',
          ...
          '</li>',
          '<li>',
            'Note: For Site Classes D and E where S<sub>1</sub>&gt;=0.20 see ',
            'requirements for site-specific ground moutions in Section 11.4.7.',
          '</li>',
          '<li>',
            '<sup>1</sup> Also, see requirements for site-specific ground ',
            'motions in Section 11.4.7.',
          '</li>',
          '<li>',
            'Note: Use straight-line interpolation for intermediate values ',
            'of S<sub>1</sub>.',
