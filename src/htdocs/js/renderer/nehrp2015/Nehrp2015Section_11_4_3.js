    ...
    try {
      ...
      section.innerHTML = [
        ...
        '<ul class="footnotes no-style">',
          '<li class="sectioning">',
            '<sup>*</sup> For Site Class E and S<sub>S</sub> &ge; 1.0 g, ',
            'see the requirements for site-specific ground motions in ',
            'Section 11.4.7 of the 2015 NEHRP Provisions. Here the exception ',
            'to those requirements allowing F<sub>a</sub> to be taken as ',
            'equal to that of Site Class C has been invoked.',
          '</li>',
          '<li>',
        ...
        '<p class="report-summary-fa page-break-after">',
          ...
          _this.outputNumber(ss), ' g, F<sub>a</sub> = ',
          _this.outputNumber(fa),
        '</p>',
        ...
        '<ul class="footnotes no-style">',
          '<li class="sectioning">',
            '<sup>1</sup> For Site Class D or E and S<sub>1</sub> &ge; 0.2 g, ',
