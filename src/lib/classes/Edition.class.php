...
class Edition {
	...
	public function __construct ($id=null, $code=null, $title=null,
				$data_source_id=null, $risk_category_label=null,
				$design_code_variant_ids=array(), $region_ids=array(),
	...
	public static function fromArray (&$p) {
		...
		return new Edition($p['id'], $p['code'], $p['title'],
					$p['data_source_id'], $p['risk_category_label'],
					$design_code_variant_ids, $region_ids, $risk_category_ids,
					$site_soil_class_ids);
	}
